...
public class MealServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        log.debug("mealServlet Post request");
...
//        repository.save(meal);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        log.debug("mealServlet Get request");
        ...
        switch (action == null ? "all" : action) {
            case "filter":
                ...
                LocalDateTime startDate = startDateStr.isEmpty() ? null : LocalDate.parse(startDateStr).atStartOfDay();
                System.out.println(startDate);
                LocalDateTime endDate = endDateStr.isEmpty() ? null : LocalDate.parse(endDateStr).plusDays(1).atStartOfDay();
